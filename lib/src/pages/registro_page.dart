...
import 'package:justificaciones/src/providers/usuario_provider.dart';
import 'package:justificaciones/src/utils/utils.dart';
        ...
        return Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              icon: Icon( Icons.alternate_email, color: Color.fromRGBO(128, 0, 0, 1.0),),
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        return Container(
          ...
          child: TextField(
            obscureText: true,
            decoration: InputDecoration(
              icon: Icon( Icons.lock_outline, color: Color.fromRGBO(128, 0, 0, 1.0),),
